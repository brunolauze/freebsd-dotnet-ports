--- /dev/null	2016-05-15 12:33:00.000000000 -0400
+++ src/System.Resources.Writer/src/SR.cs	2016-05-15 12:36:55.958540000 -0400
@@ -0,0 +1,238 @@
+using System;
...
+
+        private const String s_resourcesName = "FxResources.System.Resources.Writer.SR";
+
...
+            get
+            {
+                return typeof(FxResources.System.Resources.Writer.SR);
+            }
+        }
+
