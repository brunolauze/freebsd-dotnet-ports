--- /dev/null	2016-04-29 06:31:16.000000000 -0400
+++ src/System.Runtime.Serialization.Primitives/src/SR.cs	2016-04-29 06:32:29.976688000 -0400
@@ -0,0 +1,126 @@
+using System;
...
+            get
+            {
+                return typeof(FxResources.System.Runtime.Serialization.Primitives.SR);
+            }
+        }
+
...
+            get
+            {
+                return SR.GetResourceString("SerializationException", null);
+            }
+        }
+
