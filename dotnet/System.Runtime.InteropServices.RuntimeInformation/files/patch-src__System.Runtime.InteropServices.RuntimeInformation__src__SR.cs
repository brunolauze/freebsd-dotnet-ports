--- /dev/null	2016-03-08 07:55:28.000000000 -0500
+++ src/System.Runtime.InteropServices.RuntimeInformation/src/SR.cs	2016-03-08 07:55:47.841698000 -0500
@@ -0,0 +1,110 @@
+using System;
...
+            get
+            {
+                return SR.GetResourceString("Argument_EmptyValue", null);
+            }
+        }
+
